...
discard, test_samples = train_test_split(test, test_size=0.01, random_state=32739)
...
scaler = dataTransformer.getScaler() # Scaler used for training OT data
...
val = loss_fn(from_data, predicted_data)

print('Loss in MSE: ', val)